...
# Problem 4.10: height(some_node)
#       returns the longest path measured in arcs of the tree whose root is
#       some_node.  If some_node is a leaf, it is 0.  Otherwise, it is the
#       max of the left subtree's height and the right subtree's height.
#       (recursive)
...
class BST:
        ...
        def count(some_node):
                total = 1 + BST._count_aux(some_node, count = 0)
                return total

        def _count_aux(some_node, count):
                left = 0
                right = 0
                if some_node == None:
                        return 0
                        ...
                        if some_node.left != None:
                                left = 1 + BST._count_aux(some_node.left, count)
                        if some_node.right != None:
                                right = 1 + BST._count_aux(some_node.right, count)
                count = left + right
                return count
        ...
        def height(some_node):
                ...
                if some_node == None:
                        ...
                        if some_node.left != None:
                                left = 1 + BST.height(some_node.left)
                        if some_node.right != None:
                                right = 1 + BST.height(some_node.right)
